	...
	public class XmlHierarchyConfigurator
	{
		...
		protected void SetParameter(XmlElement element, object target) 
		{
			...
			else
			{
				...
				if(propertyValue != null)
				{
#if !(NETCF || NETSTANDARD2_0) // NETSTANDARD2_0: System.Runtime.InteropServices.RuntimeInformation not available on desktop 4.6
					try
					{
...
#if NETSTANDARD2_0 // TODO BindingFlags is available for netstandard1.5
