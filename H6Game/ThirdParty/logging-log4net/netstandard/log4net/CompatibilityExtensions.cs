...
namespace log4net
{
    internal static class CompatibilityExtensions
    {
        ...
        public static Attribute[] GetCustomAttributes(this Type type, Type other, bool inherit) => type.GetTypeInfo().GetCustomAttributes(other, inherit).ToArray() as Attribute[];
